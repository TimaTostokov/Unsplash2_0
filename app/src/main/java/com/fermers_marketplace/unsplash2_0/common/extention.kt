...
import com.fermers_marketplace.unsplash2_0.constants.Const.UNSPLASH_DIRECTORY
...
fun isPhotoExists(context: Context, fileName: String): Boolean {
    ...
    val UNSPLASH_RELATIVE_PATH =
        "${Environment.DIRECTORY_PICTURES}${File.separator}$UNSPLASH_DIRECTORY"
