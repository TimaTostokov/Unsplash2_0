...
import com.fermers_marketplace.unsplash2_0.databinding.ItemCollectionBinding

class CollectionAdapter(private val clickListener: CollectionClickListener) :
    RecyclerView.Adapter<CollectionHolder>() {

    private val listCollectionDto = mutableListOf<com.fermers_marketplace.unsplash2_0.domain.model.Collection>()
    ...
    fun addCollection(collectionDtos: List<com.fermers_marketplace.unsplash2_0.domain.model.Collection>) {
...
class CollectionHolder(itemView: View, val clickListener: CollectionClickListener) :
    ...
    fun bindCollection(collection: com.fermers_marketplace.unsplash2_0.domain.model.Collection) = with(binding) {
